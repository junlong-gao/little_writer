...
(*
Model the semaphore created by each thread. Note in the implementation it is
impossible for a thread to create more than 2 semaphore since it cannot call
